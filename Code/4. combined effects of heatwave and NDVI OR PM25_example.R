...
# 1.  Heatwave exposure metrics [heatwave events (HWE) and heatwave 
#     days (HWD)], NDVI, PM2.5 have been categorized into two groups separately 
#     based on their median values. The combination of Heatwave and NDVI/PM2.5 
#     are created and classified into four groups, with the reference group 
#     consist of low heatwave with either high NDVI or low pm2.5. 
